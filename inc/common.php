...
//======================================
// 函数: get_select_option($list, $select)
// 功能: 取得下拉列表选项
// 参数: $list          全体列表数组
// 参数: $select        默认选择项目
// 返回: 下拉列表选项
...
//======================================
// 函数: get_radio_input($list, $checked)
// 功能: 取得单选框列表选项
// 参数: $name          控件名
// 参数: $list          全体列表数组
// 参数: $checked       默认选择项目
...
//======================================
// 函数: str_to_html($value)
// 功能: 将用户输入内容转型放入数据库(HTML代码无效)
// 参数: $value         处理字符集
// 返回: 转型后字符集
//======================================
...
//======================================
// 函数: str_to_html_able($value)
// 功能: 将用户输入内容转型放入数据库(HTML代码有效)
// 参数: $value         处理字符集
// 返回: 转型后字符集
//======================================
...
//======================================
// 函数: html_to_str($value)
// 功能: 将数据库存放的用户输入内容转换回再修改内容
// 参数: $value         处理字符集
// 返回: 转型后字符集
//======================================
